...
Ref: [dbt docs](https://docs.getdbt.com/docs/build/materializations)
...
Alternatively, materializations can be configured directly inside of the model sql files. This can be useful if you are also setting [Performance Optimization] configs for specific models.
...
**Note:** `dbt-snowflake` _does not_ support materialized views, it uses Dynamic Tables instead.
